...
const AboutProfileOwnerPopUp = ({ show, handleClose, profile }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            const response = await fetch("http://localhost:8080/api/profile/update-about-owner", {
                method: "PUT",
                headers: {
    ...
    return (
        <div className="popup-overlay overlayStyle">
            <div className="popup-content popupStyle">
                ...
                <div className="row">
                    <div className="col-8">
                        <h5 className="p-3"><strong>Update my Preferences OWNER </strong></h5>
                    </div>
                    <div className="col-4">
                ...
                <textarea
                    ...
                    style={{height: "8rem"}}
                ></textarea>
                    <label htmlFor="commentCare">Preferences about ideal sitter</label>
                </div>
...
export default AboutProfileOwnerPopUp;
